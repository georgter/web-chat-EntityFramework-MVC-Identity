...
namespace WebChat.BLL.Services
{
    public class UserService : IUserService
    {
        ...
        {
            ApplicationUser user = await Database.UserManager.FindByEmailAsync(userDto.Login);
            if (user == null)
            {
                user = new ApplicationUser {UserName = userDto.Login };
                ...
                ClientProfile clientProfile = new ClientProfile { Id = user.Id, Name = userDto.Login };
